...
<%@ page import="com.poly.beans.NewsBean" %>
<%
...
<head>
    ...
    <title>Đăng tin tức - Thanh Niên</title>
...
<body>
    ...
    <div class="content-wrapper">
        <div class="form-card">
            <h2><i class="fas fa-plus-circle"></i> Đăng tin tức mới</h2>
            ...
            <form id="newsForm" method="post" action="<%= request.getContextPath() %>/news/create">
                <div class="form-group">
                    <label>Tiêu đề <span class="text-danger">*</span></label>
                    <input type="text" name="title" class="form-control" 
                           placeholder="Nhập tiêu đề tin tức (tối thiểu 10 ký tự)" 
                           value="<%= newsBean != null ? newsBean.getTitle() : "" %>"
                    ...
                    <select name="categoryId" class="custom-select" required>
                        ...
                        <% if (categories != null) {
                            for (Category category : categories) { 
                                int selectedId = (newsBean != null) ? newsBean.getCategoryId() : 0;
                        %>
                            <option value="<%= category.getId() %>" 
                                    <%= (category.getId() == selectedId) ? "selected" : "" %>>
                                <%= category.getName() %>
                            </option>
                        <% 
                            }
                ...
                <div class="form-group">
                    ...
                    <textarea name="summary" class="form-control" 
                              ...
                              required maxlength="500" id="summaryInput"><%= newsBean != null ? newsBean.getSummary() : "" %></textarea>
                    <div class="char-count">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" class="form-control" 
                              ...
                              required id="contentInput"><%= newsBean != null ? newsBean.getContent() : "" %></textarea>
                    <div class="char-count">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="image" id="imageUrl" value="<%= newsBean != null && newsBean.getImage() != null ? newsBean.getImage() : "" %>">
                    <img id="imagePreview" class="image-preview" 
                         src="<%= newsBean != null && newsBean.getImage() != null ? newsBean.getImage() : "" %>"
                         <% if (newsBean != null && newsBean.getImage() != null && !newsBean.getImage().isEmpty()) { %>
                         style="display: block;"
                         <% } %>
                    >
                </div>
    ...
    <script>
        ...
        imagePreview.title = 'Nhấn để thay đổi ảnh';
    </script>
</body>
</html>
